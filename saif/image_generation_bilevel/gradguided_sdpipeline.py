...
class GradGuidedSDPipeline(StableDiffusionPipeline):
    ...
    def __call__(
        ...
        compute_all_guidance: bool = False,
    ):
        r"""
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                with torch.enable_grad():
                    ...
                    if compute_all_guidance:
                        all_guidance.append(gradient_guidance)
        ...
        if not compute_all_guidance:
            return StableDiffusionPipelineOutput(images=image, nsfw_content_detected=has_nsfw_concept), image_eval
        else:
            return StableDiffusionPipelineOutput(images=image, nsfw_content_detected=has_nsfw_concept), image_eval, all_guidance
    ...
    # def compute_all_steps_guidance(
    #     self,
    #     reward_model,
    #     prompt: Union[str, List[str]] = None,
    #     height: Optional[int] = None,
    ...
    #                 # compute linear approximation of the reward
    #                 reward_model.eval()
    #                 prompts = [prompt] * clean_pred.shape[0]
    #                 out = reward_model(clean_pred, prompts)
    #                 #out = torch.einsum('bijk,bijk->b', self.gradients, clean_pred) + self.biases
